...
<script type="text/javascript" src="assetfront/jsfront/jquery.js"></script>
...
<div class="footer_item">
  <div class="row">
    ...
    <div class="col-6">
      <center>
        <h2 class="footer_text">BONIBALA MOVIES</h2>
        <p>Sur BONIBALA, vous avez toujours un bon film à voir !</p>
        <img class="imgfooter" src="img/footer.png" alt="footer">
      </center>
    </div>
